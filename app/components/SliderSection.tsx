...
const SliderSection = () => {
  ...
  return (
    <section id="home" className="relative pt-20 h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-4">
        <div className="text-left">
          ...
          <div className="mt-5 max-w-md sm:flex lg:justify-start sm:justify-center md:mt-8">
            <div>
              <Link
                href="#contact"
